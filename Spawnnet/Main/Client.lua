-- SpawnNet 2.2.0 COMPLETE CLIENT
...
for _,p in ipairs({'/SpawnNet-App-Platform-Client-1.0.0.lua','/SpawnNet-App-Platform-Client-1.0.1.lua','/clienthotfixV1.txt'})do if fs.exists(p)then pcall(fs.delete,p)end end
