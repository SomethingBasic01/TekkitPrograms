-- WarehouseOS 1.2.0 SpawnNet Publisher
...
add(p,{type='text',x=3,y=31,w=45,h=4,text='Next: install WarehouseOS on the inventory computer, run warehouse-controller, enter the pair code, then choose Main Output and optional Main Deposit. If this page is closed, My Warehouses > Settings can generate a fresh controller pair code at any time.'})
pages['/create']=p
...
term.clear();term.setCursorPos(1,1);term.setTextColor(C.lime);print('WAREHOUSEOS PUBLISHER 1.2.0');term.setTextColor(C.white)
...
write('Publishing... ');call('web','publish',{domain=DOMAIN,note='WarehouseOS 1.2.0 reliable controller services + warehouse lifecycle'});print('OK')
