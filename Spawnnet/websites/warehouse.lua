-- WarehouseOS 1.0.1 SpawnNet Publisher
...
term.clear();term.setCursorPos(1,1);term.setTextColor(C.lime);print('WAREHOUSEOS PUBLISHER 1.0.1');term.setTextColor(C.white)
...
write('Publishing... ');call('web','publish',{domain=DOMAIN,note='WarehouseOS 1.0.1 absolute navigation fix'});print('OK')
