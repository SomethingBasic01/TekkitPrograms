...
local function sceneDisplayName(name)
  return tostring(name or "(unnamed)")
end
...
local function showHelp()
  ...
  print("")
  print("Scenes in memory:")
  print("  - The latest scan is auto-loaded as scene: last_scan.")
  print("  - Loaded snapshots are also kept in memory for fast switching.")
  print("  - Active scene can be re-rendered without reloading from disk.")
  print("")
  print("Snapshots:")
